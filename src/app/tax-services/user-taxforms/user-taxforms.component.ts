...
@Component({
  selector: 'app-user-taxforms',
  templateUrl: './user-taxforms.component.html',
  styleUrls: ['./user-taxforms.component.scss']
})
...
ngOnInit(): void {
  this.route.params.subscribe(param => {
    ...
    this.template =  UserServices[param.serviceName]['template'];
