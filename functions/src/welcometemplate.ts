...
export const welcomeEmail = functions.https.onRequest(function (request, response) {
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi ${fullName},</p>
                        <p>
                        I’m Malcom, the co-founder of Filetax and I’d like to personally thank you for signing up to our service
                        </p>
                        
                        <p>
                        We established Filetax in order to simplify tax filing for ugandans. Large amounts
                        of paperwork, hard-to-use online forms from existing online make filing hard. It shouldn't
                        be that way. Look for email activation link sent to you and get started.
                        </p>
